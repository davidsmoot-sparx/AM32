...
#define CURRENT_OFFSET 0
#define HARDWARE_GROUP_G0_ECHOMAV
// #define USE_SERIAL_TELEMETRY
/* Note: Actual flash memory is 128kB. We use the preexisting 64kB define because it is simply used to 
...
// BEMF_A = PB7,  BEMF_B = PB3, BEMF_C = PA2
//! @todo: Figure out how to make use of BEMF_COM:
// We amplify(10.0kresistors/phase) and consolidate/reconcile these values 
// to a single BEMF_COM signal available at PA3. The STM32 documentation
...
#define VOLTAGE_ADC_CHANNEL LL_ADC_CHANNEL_10
